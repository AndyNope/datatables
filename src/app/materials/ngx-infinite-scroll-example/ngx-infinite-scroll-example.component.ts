...
@Component({
  selector: 'app-ngx-infinite-scroll-example',
  templateUrl: './ngx-infinite-scroll-example.component.html',
  styleUrls: ['./ngx-infinite-scroll-example.component.css']
})
export class NgxInfiniteScrollExampleComponent implements OnInit {
